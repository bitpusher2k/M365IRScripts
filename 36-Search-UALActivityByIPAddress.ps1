...
#
# powershell -executionpolicy bypass -f .\Search-UALActivityByIPAddress.ps1 -OutputPath "Default" -IPs "1.1.1.1,8.8.8.8" -StartDate "2025-07-12" -EndDate "2025-07-20"
#
...
param(
    ...
    [datetime]$StartDate,
    [datetime]$EndDate,
    [string]$scriptName = "Search-UALActivityByIPAddress",
...
if (!$AuditOutput) {
    ...
    Write-Output "`nSee IP address activities report in the output path.`n" | Tee-Object -FilePath $logFilePath -Append
}
