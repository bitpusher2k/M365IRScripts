...
$OutputHeaders = ("DateUTC", "DateOnly", "TimeOnly", "User", "Username", "IPaddress", "City", "Region", "Country", "Status", "UserType", "AuthRequirement", "ConditionalAccess", "TokenType", "Application", "Resource", "ResourceID", "FailureReason", "ClientApp", "Browser", "OS", "UserAgent", "Compliant", "Managed", "JoinType", "Latency", "MFAResult", "MFAMethod", "MFADetail")
