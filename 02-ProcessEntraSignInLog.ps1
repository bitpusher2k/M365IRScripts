...
param(
    [string[]]$inputFiles = @("EntraSignIn.csv"),
...
foreach ($inputFile in $inputfiles) {
    ...
    $OutputHeaders = ("DateUTC", "DateOnly", "TimeOnly", "User", "Username", "IPaddress", "City", "Region", "Country", "Status", "SignInErrorCode", "UserType", "AuthRequirement", "ConditionalAccess", "TokenType", "Application", "ApplicationID", "Resource", "ResourceID", "FailureReason", "ClientApp", "DeviceID", "Browser", "OS", "UserAgent", "Compliant", "Managed", "JoinType", "Latency", "MFAResult", "MFAMethod", "MFADetail", "SignInIdentifier", "SessionID", "AuthenticationProtocol", "UniqueToken", "TransferMethod", "ClientCredential", "TokenProtectionSession", "TokenProtectionStatusCode", "CorrelationID")
