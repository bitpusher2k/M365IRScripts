...
# Minimally required tenant role(s): "Conditional Access Administrator"
#
# If not connected:
...
#Requires -Modules Microsoft.Graph.Identity.SignIns, Microsoft.Graph.Users, Microsoft.Graph.Groups, Microsoft.Graph.Identity.DirectoryManagement
...
Assert-M365Connection -RequireGraph -GraphScopes @("Domain.Read.All", "Organization.Read.All", "Policy.Read.All", "Policy.ReadWrite.ConditionalAccess", "User.Read.All")
