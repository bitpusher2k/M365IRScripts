...
Assert-M365Connection -RequireGraph -GraphScopes @("Domain.Read.All", "IdentityRiskEvent.Read.All", "IdentityRiskyUser.Read.All")
...
Write-Output "To dismiss a risky user: Invoke-MgDismissRiskyUser -UserIds @('<userId>')"
