...
# Minimally required tenant role(s): "User Administrator" + may need "Privileged Auth Admin" to operate on admin accounts
#
# If not connected:
...
Assert-M365Connection -RequireGraph -GraphScopes @("Domain.Read.All", "User.Read.All", "User.ReadWrite.All")
